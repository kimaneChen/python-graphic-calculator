...
def InputItem(num, formula):
    return [sg.Column(size=(1000,46),background_color='#859FCC',pad=0,layout=[[sg.Text(f'{num}. ',size=(3,2),pad=0,background_color='#859FCC'), sg.Input(**inputs,pad=0,key="inf"+str(num),size=(27,100),border_width=0,default_text=str(formula)), sg.Button('X',size=(2,1),button_color=('#F7F7F7','#859FCC'), key="deleteButton"+str(num))],[sg.HorizontalSeparator(pad=(0,5),color='#53697c')]])]
...
zoomButtonColumn=[[sg.vbottom(sg.Button(image_source="zoom.png",key="zoomOut",border_width=0,pad=(0,10),image_subsample=15,button_color='#859FCC',image_size=(40,40)))],
                [sg.vbottom(sg.Button(image_source="zoom-out.png",key="zoomIn",pad=0,border_width=0,image_subsample=15,button_color='#859FCC',image_size=(40,40)))]]
runColumn=[[sg.vtop(sg.Button(image_source="zoom.png",key="run",border_width=0,pad=(0,0),image_subsample=15,button_color='#859FCC',image_size=(40,40)))]]

functionList=[]

layout=[
    [sg.pin(sg.Column(layout=topColumn,expand_x=True,size=(2000,50),pad=0))],
    [sg.pin(sg.Column(layout=inputColumn,size=(500,665),background_color='#859FCC',pad=0,scrollable=True,vertical_scroll_only=True,key="inputColumn")),sg.pin(elem=sg.Graph(canvas_size=(900, 650), graph_bottom_left=(-10,-7.222), graph_top_right=(10,7.222),background_color='white',enable_events=True,float_values = True, drag_submits=True,border_width=5, key='graph'),vertical_alignment = None,shrink = True,expand_x = True,expand_y = True,),sg.vtop(sg.Column(layout=zoomButtonColumn))],
    [sg.pin(sg.Column(layout=sizeColumn,background_color='#859FCC',pad=0,size=(42,45),key="sizeColumn")),sg.pin(sg.Column(layout=buttonColumn,background_color='#859FCC',pad=0,size=(472,45),key="buttonColumn")),sg.pin(sg.Column(pad=(2,0),layout=runColumn,size=(45,60)))]
]
